...
#import "KMTextKitAppDelegate.h"
#import "KMTextKitViewController.h"
@implementation KMTextKitAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    KMTextKitViewController *vc = [[[KMTextKitViewController alloc] init] autorelease];
